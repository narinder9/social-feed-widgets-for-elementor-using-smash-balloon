<?php
namespace sfafe\feedback;

class SFAFE_feedback{

	private $plugin_url = SFAFE_URL;
	private $plugin_version = SFAFE_VERSION;
	private $plugin_name = 'Social Feed Widgets For Elementor Using Smash Balloon';
	private $plugin_slug = 'sfafe';
